...
export default function MissingRoot() {
  return (
    <RecordShell current="/suture" crumb="the missing root" status="[surviving record verified; origin root absent]">
      ...
      <p className="lede">
        The thirteen surviving thought commits form a parent-linked chain and
      ...
      <div className="root-slip">
        ...
        <small>Reproducible from the thirteen thought commits; source published at github.com/apoira/apoira.</small>
      </div>
