...
Version 0.6 assumes a trusted local host and untrusted portfolio proposals. The
...
Version 0.6 contains explicitly armed CLI and agent-callable MCP paths capable
